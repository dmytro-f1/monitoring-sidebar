...
<template>
  <div class="relative">
    ...
    <input
      ...
      class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
    />
    <button
      v-if="query"
      @click="query = ''"
